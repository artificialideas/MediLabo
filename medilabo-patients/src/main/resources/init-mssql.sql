...
INSERT [dbo].[patients] ([id_patient], [first_name], [last_name], [birthdate], [gender], [address], [phone_number]) VALUES ('fc75ee91-3e8e-4de9-b4e2-f39556cd1dd2', 'Test', 'TestEarlyOnset', '2002-06-2', 'F', '4 Valley Dr', '400-555-6666');